...
const page = (props) => {
  ...
  const castNcrew = async () => {
    const {data} = await axios.get(`https://api.themoviedb.org/3/tv/${showId}/credits?api_key=2a325f825de42d66968dbc58f1703c53`)
  ...
  return (
    <>
      ...
      <div className={styles.container}>
        <img src={`https://image.tmdb.org/t/p/w1920_and_h800_multi_faces/${TvShowsDetails.backdrop_path}?api_key=2a325f825de42d66968dbc58f1703c53`} alt="" />
        <div className={styles.overlay}>
          <div className={styles.poster}>
            <img src={`https://image.tmdb.org/t/p/w500//${TvShowsDetails.poster_path}?api_key=2a325f825de42d66968dbc58f1703c53`} alt="" />
          </div>
